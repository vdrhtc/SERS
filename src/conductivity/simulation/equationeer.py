...
class Equationeer(object):
    ...
    def create_equation_matrix_and_ordinate_low_memory(self, variables, grid):
        B = sparse.lil_matrix((len(variables), len(variables)))
    ...
    def create_equation_matrix_and_ordinate(self, variables, grid):
        ...
        """A very, very, very ugly (but fast) piece of code based on operations
        in methods cirquit_ and node_equations"""
